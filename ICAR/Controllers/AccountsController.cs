...
namespace ICAR.Controllers
{
    public class AccountsController : Controller
    {
        ...
        public AccountsController(ICARContext context)
        {
            _context = context;
        }
        //Get
        ...
        public async Task<IActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            {
                ModelState.AddModelError("", "Active Directory Issue : " + loginresult);
                return View(model);
            }
        ...
        {
             var users = _context.Users.Include(e => e.Departments).Include(e => e.Roles).Where(u => u.Status == "1")
            ...
            var claims = new List<Claim>
                {
                    ...
                    new Claim("DepartmentName", user.Departments.Name),
